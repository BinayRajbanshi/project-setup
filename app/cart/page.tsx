      ...
      <div className="flex flex-col md:flex-row">
        <div className="bg-white p-3 md:w-3/4 md:p-10">
          <div className="flex justify-between border-b pb-4 md:pb-8">
            <h1 className="text-lg font-semibold md:text-2xl">Shopping Cart</h1>
            <h2 className="text-lg font-semibold md:text-2xl">0 Items</h2>
          </div>
          ...
          <div className="relative my-4 flex h-24 items-center bg-gray-100">
            <button className="absolute right-3 top-1/4 -translate-y-3/4 rounded bg-red-600 p-1 text-sm text-white md:right-8 md:top-2/4 md:-translate-y-2/4 md:rounded-md md:p-2 md:text-base">
              <BsFillTrashFill />
            </button>
            <div className="w-6/12 flex-grow md:flex-grow-0">
              <div className="flex items-center">
                ...
                <div className="ml-3 flex flex-grow flex-col md:flex-grow-0">
                  <p className="font-semibold md:text-lg">Iphne</p>
                  <p className="font-light">applw</p>
            ...
            <div className="md: hidden w-2/12 md:block">$1000</div>
